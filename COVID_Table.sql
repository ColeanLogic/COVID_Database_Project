...
(
    patient_id NUMERIC(6,0) NOT NULL AUTO_INCREMENT,
...
(
    hospital_id NUMERIC(6,0) NOT NULL AUTO_INCREMEMNT,
...
(
    case_id NUMERIC(7,0) NOT NULL AUTO_INCREMENT,
...
CREATE VIEW comprehensive_summary AS
...
ALTER TABLE patient AUTO_INCREMENT=500775;
ALTER TABLE hospital AUTO_INCREMENT=600030;
ALTER TABLE case_no AUTO_INCREMENT=800302;
